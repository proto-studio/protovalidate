...
type EmailRuleSet struct {
	...
	label         string
	conflictType  emailConflictType // New unexported field for fast conflict checking
}
...
func (ruleSet *EmailRuleSet) WithRequired() *EmailRuleSet {
	newRuleSet := ruleSet.cloneWithConflictType(emailConflictTypeRequired)
...
func (ruleSet *EmailRuleSet) WithNil() *EmailRuleSet {
	newRuleSet := ruleSet.cloneWithConflictType(emailConflictTypeNil)
...
func (ruleSet *EmailRuleSet) cloneWithConflictType(conflictType emailConflictType) *EmailRuleSet {
