...
// Apply coerces input to string, evaluates all rules, and returns the result.
func (ruleSet *DomainRuleSet) Apply(ctx context.Context, input any) (string, errors.ValidationError) {
